...
export class FoodController {
  ...
  @ApiOperation({
    ...
    description: 'Yangi ovqat (taom) qo‘shish uchun ishlatiladi. Fayl (rasm) bilan birga yuboriladi.',
  })
  @ApiConsumes('multipart/form-data')
  @ApiBody({ description: 'Yangi ovqat qo‘shish uchun DTO', type: CreateFoodDto })
  ...
  @ApiConsumes('multipart/form-data')
  @ApiBody({ description: 'Ovqatni yangilash uchun DTO', type: UpdateFoodDto })
  @ApiParam({ name: 'id', type: 'string', description: 'Ovqat ID (UUID)' })
  ...
  @ApiParam({ name: 'id', type: 'string', description: 'Ovqat ID (UUID)' })
  @ApiBody({ type: FoodSequenceDto, description: 'Tartib raqamini yangilash uchun DTO' })
  @ApiResponse({ status: 200, description: 'Tartib raqami muvaffaqiyatli yangilandi' })
  @ApiResponse({ status: 404, description: 'Ovqat topilmadi' })
  async updateSequence(@Param('id') id: string, @Body() dto: FoodSequenceDto) {
